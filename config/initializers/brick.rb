...
if ActiveRecord::Base.respond_to?(:brick_select) && !::Brick.initializer_loaded
  ...
  # # Here is a possible additional reference that has been auto-identified for the be_in_touch database:
  # Brick.additional_references = [['pals', 'relation_id', 'relations']]
  # # Columns named somewhat like a foreign key which you may want to consider:
  # #   pals.friender_id, pals.friendee_id, passions.created_by_id
  ...
  # # Here is a possible polymorphic association that has been auto-identified for the be_in_touch database:
  # Brick.polymorphics = { ['pals', 'relation_id', 'relations'] }
